...
<template>
    <div class="flex items-end gap-1.5 px-3 py-0.5">
        ...
        <div class="bg-[var(--color-surface-muted)]/90 border border-[var(--color-border-subtle)] rounded-2xl rounded-tl-md px-3.5 py-2.5 flex items-center gap-1 shadow-sm">
