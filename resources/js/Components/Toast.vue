...
<template>
    <transition name="toast-slide">
        <div v-if="show" class="fixed top-5 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-sm">
            <div :class="[
                'rounded-xl p-4 shadow-xl border flex items-center gap-3',
                type === 'success' ? 'bg-gradient-to-br from-green-900 to-gray-900 border-green-500/30' : 'bg-gradient-to-br from-red-900 to-gray-900 border-red-500/30'
            ]">
                <div :class="[
