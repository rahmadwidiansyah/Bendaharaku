    ...
    <div class="fixed bottom-24 left-1/2 -translate-x-1/2 w-full max-w-md pointer-events-none flex justify-end px-5 z-40">
        <div class="flex flex-col gap-4 items-end pointer-events-auto">
            ...
            <div class="flex flex-col gap-4 items-end mb-1">
                ...
                <transition name="fab-sub">
                    <a v-if="isOpen" href="https://t.me/catatwidi_bot" target="_blank" 
                        class="relative group w-11 h-11 bg-blue-500/90 backdrop-blur-sm rounded-xl flex justify-center items-center text-white active:scale-95 transition-all shadow-lg hover:shadow-blue-500/20 shadow-black/50"
                        ...
                        <div class="absolute right-14 bg-gradient-to-br from-gray-900 to-gray-800 border border-white/10 text-white text-[10px] font-black uppercase tracking-widest px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap shadow-xl">
                            Telegram Bot
                        </div>
                    </a>
                </transition>
                ...
                <transition name="fab-sub">
                    <Link v-if="isOpen" :href="route('transactions.create')" 
                        class="relative group w-11 h-11 bg-white rounded-xl flex justify-center items-center text-black active:scale-95 transition-all shadow-lg shadow-black/50"
            ...
            <button @click="toggleMenu" 
                class="w-13 h-13 bg-gradient-to-br from-purple-800 to-purple-500 rounded-2xl flex justify-center items-center text-white active:scale-90 transition-all shadow-xl shadow-purple-500/20 border border-white/10 group relative overflow-hidden"
