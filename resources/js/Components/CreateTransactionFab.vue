...
<template>
    <div
        :class="['fixed bottom-24 left-1/2 -translate-x-1/2 w-full max-w-md pointer-events-none flex justify-end px-5 z-40', isDesktopLayout ? 'lg:hidden' : '']">
        <div class="flex flex-col gap-4 items-end pointer-events-auto">
            ...
            <div class="flex flex-col gap-4 items-end mb-1">
                ...
                <transition name="fab-sub">
                    <a v-if="isOpen" href="https://t.me/catatwidi_bot" target="_blank"
                        ...
                        <div
                            class="absolute right-14 bg-gradient-to-br from-gray-900 to-gray-800 border border-white/10 text-white text-2xs font-black uppercase tracking-widest px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                            Telegram Bot
                        </div>
                    </a>
                </transition>
            ...
            <button @click="toggleMenu"
                ...
                <svg class="w-7 h-7 transition-transform duration-300" fill="none" stroke="currentColor"
