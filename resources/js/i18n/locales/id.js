...
categoryTab: {
    ...
    settings: {
        ...
        privacy: {
            ...
            logs: {
                ...
                page_desc:      'Riwayat lengkap aktivitas akun — transaksi, memory AI, perubahan pengaturan, dan chat.',
                filters: {
                    all:         'Semua',
                    transaction: 'Transaksi',
                    memory:      'Memory',
                ...
                empty_desc:     'Aktivitas akan muncul di sini setelah kamu membuat transaksi, mengubah pengaturan, atau chat dengan AI.',
                empty_filter:   'Filter aktif:',
                ...
                hint_title:     'Kenapa memory kosong?',
                hint_desc:      'Memory hanya belajar dari sumber Telegram / Web Chat / OCR / Draft (lihat LearnFromTransaction). Transaksi yang dibuat langsung via /transactions/create (WEB) tidak melatih memory & subject default "-" diabaikan. Cek log di atas dengan filter Memory untuk melihat CREATED/REWARDED. Jika tetap 0, coba buat transaksi via Chat atau isi Subject (mis. “Bakso Malang”) sebelum simpan.',
            },
    ...
    chat: {
        ...
        captionHint: 'Tambahkan caption (opsional)',
        removeAttachment: 'Hapus lampiran',
        error: {
            sendFailed: 'Gagal mengirim pesan. Periksa koneksi internet.',
            evidenceFailed: 'Gagal mengirim bukti. Periksa koneksi internet.',
            connection: 'Gagal terhubung ke server. Coba lagi.',
            uploadFailed: 'Upload gagal',
            loadDraftFailed: 'Gagal memuat data draft',
            saveFailed: 'Gagal menyimpan',
            commitFailed: 'Gagal membuat transaksi',
        },
        evidenceReview: {
            title: 'Review Transaksi',
            subtitle: 'Periksa dan edit data sebelum disimpan',
