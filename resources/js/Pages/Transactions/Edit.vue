        ...
        <div class="p-5 pb-32 max-w-md mx-auto relative">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="flex gap-3 mt-6">
                    <button type="button" @click="destroy" class="flex-1 bg-[#1A1A1A] border border-[#262626] text-red-500 font-bold text-sm uppercase tracking-widest py-4 rounded-[1.5rem] active:scale-95 transition-all">
                        Hapus
                    </button>
                    <button type="submit" :disabled="form.processing" class="flex-[2] bg-purple-500 text-[#121212] font-bold text-sm uppercase tracking-widest py-4 rounded-[1.5rem] shadow-lg active:scale-95 transition-all">
                        Update
                    </button>
                </div>
            </form>
