...
<template>
    ...
    <div class="antialiased selection:bg-gray-600 relative flex justify-center min-h-screen bg-gray-800 text-white font-sans overflow-x-hidden">
        ...
        <div class="w-full max-w-md relative z-10 flex flex-col justify-center min-h-screen bg-gray-800 px-6 py-10">
            ...
            <div class="animate-slide-up w-full">
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between px-1">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            ...
                            />
                            <span class="text-xs font-bold text-gray-500 group-hover:text-gray-300 transition-colors">Ingat Saya</span>
                        </label>
                        <Link
                            v-if="canResetPassword"
                            :href="route('password.request')"
                            class="text-xs font-bold text-purple-500 hover:text-white transition-colors"
                        >
                            Lupa Password?
                        </Link>
                    </div>
                ...
                <a
                    ...
                    class="w-full flex items-center justify-center gap-3 bg-gradient-to-br from-gray-900 to-gray-800 text-white border border-white/10 font-bold text-xs uppercase tracking-widest py-4 rounded-xl active:scale-95 transition-all hover:border-[#FCA5FF] hover:text-white"
                >
