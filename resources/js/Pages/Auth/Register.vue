...
<template>
    ...
    <div class="antialiased selection:text-black relative flex justify-center min-h-screen bg-gray-800 text-white font-sans overflow-x-hidden">
        
        <div class="fixed top-[20%] left-[50%] -translate-x-1/2 w-[300px] h-[300px] bg-gray-800 blur-[120px] opacity-[0.15] rounded-full pointer-events-none z-0"></div>
            ...
            <div class="animate-slide-up w-full">
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    <div>
                        ...
                        />
                        <div v-if="form.errors.name" class="text-xs text-red-500 mt-1 block font-bold">
                            {{ form.errors.name }}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        />
                        <div v-if="form.errors.password" class="text-xs text-red-500 mt-1 block font-bold">
                    ...
                    <div>
                        ...
                        />
                        <div v-if="form.errors.password_confirmation" class="text-xs text-red-500 mt-1 block font-bold">
                ...
                <a
                    ...
                    class="w-full flex items-center justify-center gap-3 bg-gradient-to-br from-gray-900 to-gray-800 text-white border border-white/10 font-bold text-xs uppercase tracking-widest py-4 rounded-xl active:scale-95 transition-all hover:border-purple-500 hover:text-white"
                >
                    <img src="https://www.gstatic.com/images/branding/product/1x/gsa_512dp.png" alt="Google" class="w-5 h-5" />
                    Daftar dengan Google
                </a>

                <p class="text-center text-xs font-bold text-gray-500 mt-10">
                    Sudah punya akun?
