        ...
        <div
            ...
            <div class="animate-slide-up w-full max-w-md mx-auto">
                <div class="text-center mb-10">
                    ...
                    <h1 class="text-3xl font-bold text-[var(--color-text-primary)] tracking-tight">Reset Password</h1>
                    <p class="text-2xs text-[var(--color-text-muted)] uppercase tracking-widest mt-2 font-bold">Buat sandi baru Anda</p>
                </div>

                <form @submit.prevent="submit" class="space-y-5">
                    <div>
                        <label
                            class="block text-2xs font-bold text-[var(--color-text-secondary)] uppercase tracking-widest mb-1.5 ml-1">Email</label>
                    ...
                    <div>
                        <label
                            class="block text-2xs font-bold text-[var(--color-text-secondary)] uppercase tracking-widest mb-1.5 ml-1">Konfirmasi
                            Password</label>
