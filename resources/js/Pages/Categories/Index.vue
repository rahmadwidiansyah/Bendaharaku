            ...
            <header class="mb-10 pt-4 animate-fade-in-up">
                ...
                <div :class="['grid grid-cols-1 gap-4', isDesktopLayout ? 'sm:grid-cols-1' : '']">
                    <Link :href="route('settings.index')"
                        class="relative w-full min-h-16 py-3 bg-linear-to-br from-gray-900 to-gray-800 border border-white/10 rounded-xl flex items-center justify-between px-4 sm:px-6 active:scale-[0.97] transition-all group overflow-hidden shadow-2xl">
                        <div
                        ...
                        <div class="relative z-10 flex items-center gap-3 sm:gap-4 w-full pr-8">
                            <div
                                class="w-8 h-8 shrink-0 rounded-lg bg-blue-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                            ...
                            <div class="flex flex-col min-w-0">
                                <span
                                    class="text-sm font-bold text-white uppercase tracking-wide truncate">Pengaturan</span>
                                <span
                                    class="text-2xs sm:text-2xs text-gray-500 font-bold uppercase tracking-widest mt-0.5 leading-tight">Konfigurasi
                                    Web</span>
                            </div>
                        </div>
                        ...
                        <div class="absolute right-4 sm:right-6 z-10 flex items-center top-1/2 -translate-y-1/2">
                            <div
                                class="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center group-hover:border-blue-500/50 transition-colors">
                                <svg class="w-4 h-4 text-gray-500 group-hover:text-blue-500 group-hover:translate-x-0.5 transition-all"
