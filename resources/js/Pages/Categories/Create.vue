    ...
    <AuthenticatedLayout :fullWidth="true">
        ...
        <div class="p-4 sm:p-5 w-full lg:max-w-7xl mx-auto lg:px-8 relative animate-fade-in-up">
            ...
            <header class="hidden lg:block mb-8 pt-4">
                ...
                <h1 class="text-2xl font-bold text-[var(--color-text-primary)] tracking-tight">{{ t('category.titleCreate') }}</h1>
            </header>
            ...
            <form @submit.prevent="submit" class="space-y-5 lg:space-y-6">
                ...
                <div class="pt-3 lg:pt-4">
                    <button type="submit" :disabled="form.processing"
                        class="w-full bg-linear-to-br from-brand-deep to-brand-mid text-[var(--color-text-primary)] font-bold text-sm tracking-wide py-3.5 lg:py-4 rounded-xl active:scale-95 transition-all duration-200 hover:-translate-y-0.5">
