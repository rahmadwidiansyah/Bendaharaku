  ...
  <AuthenticatedLayout :fullWidth="true">
    ...
    >
      <SettingsCard :title="t('settings.privacy.danger.delete_account.title')" :description="t('settings.privacy.danger.delete_account.description')">
        <div class="space-y-4">
          <p class="text-2xs sm:text-sm text-gray-400">{{ t('settings.privacy.danger.delete_account.warning') }}</p>
          <button
            @click="showDeleteConfirm = true"
            :disabled="isDeleting || showDeleteConfirm"
            class="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2.5 bg-red-600 hover:bg-red-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white rounded-lg sm:rounded-xl text-sm font-medium transition-colors"
          >
            ...
            <div class="bg-gray-900 rounded-lg sm:rounded-xl p-4 sm:p-6 max-w-sm mx-4 border border-gray-700 w-full" role="dialog" aria-modal="true" aria-labelledby="delete-modal-title" aria-describedby="delete-modal-desc">
              ...
              <div class="flex gap-2 sm:gap-3">
                <button
                  ...
                  :disabled="isDeleting"
                  class="flex-1 px-3 py-1.5 sm:px-4 sm:py-2.5 bg-gray-700 hover:bg-gray-600 disabled:opacity-50 text-white rounded-lg sm:rounded-xl text-sm font-medium transition-colors"
                >
                  {{ t('common.cancel') }}
                </button>
                <button
                  ...
                  :disabled="isDeleting"
                  class="flex-1 px-3 py-1.5 sm:px-4 sm:py-2.5 bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white rounded-lg sm:rounded-xl text-sm font-medium transition-colors"
                >
