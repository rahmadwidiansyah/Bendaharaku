    ...
    >
      <form @submit.prevent="handleSave" class="space-y-3 sm:space-y-5">
        <SettingsCard :title="t('settings.account.preferences.language.title')" :description="t('settings.account.preferences.language.description')">
          <select v-model="language" class="w-full px-3 py-1.5 sm:px-4 sm:py-2.5 bg-gray-800 border border-gray-700 rounded-lg sm:rounded-xl text-white focus:outline-none focus:border-purple-500 transition-all text-sm">
        ...
        <SettingsCard :title="t('settings.account.preferences.timezone.title')" :description="t('settings.account.preferences.timezone.description')">
          <select v-model="timezone" class="w-full px-3 py-1.5 sm:px-4 sm:py-2.5 bg-gray-800 border border-gray-700 rounded-lg sm:rounded-xl text-white focus:outline-none focus:border-purple-500 transition-all text-sm">
            <option>UTC</option>
        ...
        <SettingsCard :title="t('settings.account.preferences.date_format.title')" :description="t('settings.account.preferences.date_format.description')">
          <select v-model="dateFormat" class="w-full px-3 py-1.5 sm:px-4 sm:py-2.5 bg-gray-800 border border-gray-700 rounded-lg sm:rounded-xl text-white focus:outline-none focus:border-purple-500 transition-all text-sm">
