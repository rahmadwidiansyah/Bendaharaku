    ...
    >
      <form @submit.prevent="handleSave" class="space-y-3 sm:space-y-5">
        ...
        <div class="flex flex-col items-center py-2 sm:py-3">
          ...
          <p class="mt-3 text-sm font-semibold text-white">{{ user.name }}</p>
          ...
          <div class="space-y-3">
            <div>
              ...
              <input
                ...
                type="text"
                required
                class="w-full px-3 py-1.5 sm:px-4 sm:py-2.5 bg-gray-800 border border-gray-700 rounded-lg sm:rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500/30 transition-all text-sm"
        ...
        >
          <div class="space-y-3">
            <!-- WhatsApp -->
            <div>
              <label class="flex items-center gap-2 text-2xs font-bold text-gray-400 uppercase tracking-widest mb-1 ml-1">
              ...
              <input
                ...
                class="w-full px-3 py-1.5 sm:px-4 sm:py-2.5 bg-gray-800 border border-gray-700 rounded-lg sm:rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500/20 transition-all text-sm"
              />
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-3 py-1.5 sm:px-4 sm:py-2.5 bg-gray-800 border border-gray-700 rounded-lg sm:rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/20 transition-all text-sm"
              />
        ...
        >
          <div v-if="!user.google_id">
            <a
              ...
              class="inline-flex items-center gap-2 px-3 py-2 sm:px-5 sm:py-3 bg-gray-800 hover:bg-gray-700 border border-white/10 hover:border-white/20 text-white text-xs font-bold uppercase tracking-wider rounded-lg sm:rounded-xl transition-all"
            >
