        ...
        <div class="space-y-4">
          ...
          <div :class="[
            ...
            isTelegramActive 
              ...
              : 'bg-[var(--color-surface-muted)]/50 border-[var(--color-border-default)]'
          ]">
            <div :class="[
            ...
            <div>
              <p :class="['text-sm font-semibold', isTelegramActive ? 'text-emerald-400' : 'text-[var(--color-text-secondary)]']">
                {{ isTelegramActive ? 'Active' : 'Not Connected' }}
              </p>
              <p v-if="isTelegramActive" class="text-xs text-[var(--color-text-secondary)] mt-0.5">
                ID: {{ telegramId }}
              </p>
            </div>
          </div>
          ...
          <a
            ...
            class="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 active:scale-95 text-[var(--color-text-primary)] rounded-lg text-sm font-semibold transition-all"
          >
