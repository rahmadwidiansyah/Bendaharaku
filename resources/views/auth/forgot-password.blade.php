...
<head>
    ...
    <title>Lupa Password - Bendaharaku</title>
    ...
    <div class="w-full max-w-md relative z-10 flex flex-col justify-center min-h-screen border-x border-[#262626]/50 bg-[#121212]/80 backdrop-blur-xl shadow-2xl px-6 py-10">
        ...
        <div class="animate-slide-up w-full">
            <div class="text-center mb-8">
                ...
                <p class="text-[10px] text-gray-500 uppercase tracking-widest mt-2 font-bold">Kami bantu meresetnya</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Email Anda</label>
            ...
            <p class="text-center text-[11px] font-bold text-gray-500 mt-8">
                Ingat password Anda? <a href="{{ route('login') }}" class="text-[#FCA5FF] hover:text-white transition-colors">Masuk di sini</a>
            </p>
        </div>
