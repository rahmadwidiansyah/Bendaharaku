            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required autofocus
                        class="w-full bg-[#1A1A1A] border border-[#333] text-white rounded-[1.5rem] p-4 text-sm focus:border-[#FCA5FF] focus:outline-none focus:ring-1 focus:ring-[#FCA5FF] transition-all shadow-inner" placeholder="John Doe">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required
                        class="w-full bg-[#1A1A1A] border border-[#333] text-white rounded-[1.5rem] p-4 text-sm focus:border-[#FCA5FF] focus:outline-none focus:ring-1 focus:ring-[#FCA5FF] transition-all shadow-inner" placeholder="email@contoh.com">
                ...
                <div>
                    ...
                    <input type="password" name="password" required
                        class="w-full bg-[#1A1A1A] border border-[#333] text-white rounded-[1.5rem] p-4 text-sm focus:border-[#FCA5FF] focus:outline-none focus:ring-1 focus:ring-[#FCA5FF] transition-all shadow-inner" placeholder="Minimal 8 karakter">
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" required
                        class="w-full bg-[#1A1A1A] border border-[#333] text-white rounded-[1.5rem] p-4 text-sm focus:border-[#FCA5FF] focus:outline-none focus:ring-1 focus:ring-[#FCA5FF] transition-all shadow-inner" placeholder="Ulangi password">
                </div>
