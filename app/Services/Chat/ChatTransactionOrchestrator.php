...
class ChatTransactionOrchestrator
{
    ...
    private function findCategoryForDraft(?string $text, Collection $categories): Category
    {
        if (blank($text)) {
    ...
    private function findSystemWalletId(string $walletName, Collection $wallets): int
    {
